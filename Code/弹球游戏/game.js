...
(function() {
    ...
    window.requestAnimFrame = (function() {
        ...
        function(callback) {
            ...
            //显示器显示频率每一秒60帧频，根据这个控制显示器的刷新频率，比较节省系统资源，这里1000/60即是17ms，
        };
    })();
    ...
    var Game = {
        // Setup configuration
        canvas: document.getElementById('canvas'),//Code used to render your Canvas
        setup: function() {
    ...
    ***************************/
    ...
    var Paddle = {
        ...
        move: function() {
            ...
            // Prevent ball and paddle from flyinng offscreen
